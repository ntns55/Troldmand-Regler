...
\textbf{Kommando:} Forklar effekten grundigt.
\end{sjæl*}\todo{Dette er nu midlertidig LP.}
...
\end{dHævn*}\todo{Ændret kraftigt, og gjort til niveau 3}
...
\end{dHævn*}\todo{Gjort til niveau 4}
...
\end{itemize}
\end{korruption*}\todo{Tilføjet Lysets Dæmon}
...
\end{falden*}\todo{Sat tidsbegræsnings på.}
...
\textbf{Kommando:} Forklar effekten grundigt.
\end{falden*}\todo{Gjort at kasteren ikke kan påvirkes af denne magi, hvis de allerede har den.}