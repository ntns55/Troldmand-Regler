...
\addcontentsline{toc}{chapter}{Elementalist}
...
\begin{primærMagi*}[Magiens sværd]
\textbf{Type:} -\\
\textbf{Kategori:} Passiv\\
\textbf{Effekt:} Tillader Elementalisten at bruge sværd til at kæmpe med. Sværdet kan ikke være længere end din arm.
\end{primærMagi*}
...
\section*{Vand}\addcontentsline{toc}{section}{Vand}
\begin{vand*}[Isslag]
...
\section*{Ild}\addcontentsline{toc}{section}{Ild}
\begin{ild*}[Gnist]
\textbf{Type:} Øjeblikkeligmagi\\
\textbf{Kategori:} Berøringsmagi\\
...
\section*{Jord}\addcontentsline{toc}{section}{Jord}
...
\section*{Vind}\addcontentsline{toc}{section}{Vind}
\begin{vind*}[Vindstød]
\textbf{Type:} Øjeblikkeligmagi\\
\textbf{Kategori:} Pegemagi\\
