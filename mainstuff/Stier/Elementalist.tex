...
\textbf{Kategori:} Berøringsmagi\\
\textbf{Rite:} Give, Vand, Trække, Bevægelse, Død\\
\textbf{Effekt:} Du fjerner alt rustning fra subjektet.\\
\textbf{Kommando:} ”Mist alt RP”
\end{vand*}
...
\begin{vind*}[Hvirvelvind]
    \textbf{Type:} Øjeblikkeligmagi\\
    \textbf{Kategori:} Pegemagi\\
    \textbf{Rite:} Magi, Trække, Give\\
    \textbf{Effekt:} Et stærkt vindstød får subjektet til at vende sig.\\
    \textbf{Kommando:} "Hvirvelvind - vend dig om."
\end{vind*}
